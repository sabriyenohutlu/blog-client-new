...
import { Heart, Share2, BookOpen, ArrowRight, Calendar, User } from "lucide-react";
...
const recentPoems = [
  ...
  },
  {
    ...
    date: "10 Mart 2024",
    likes: 157,
    excerpt: "Gül devrini yaşıyoruz, kan kırmızı / Gül kokusundan geçilmiyor ortalık..."
  }
];

export default function Siir() {
  return (
    <>
      <NextSeo
                ...
                <CardContent className="p-0">
                  <div className="relative h-48">
                    ...
                    <div className="absolute bottom-4 left-4 right-4 text-white">
                      ...
                      <p className="text-sm text-gray-300">{poem.author}</p>
                    </div>
                  </div>
                  <div className="p-6">
                ...
                <CardContent className="p-6">
                  <div className="flex items-start justify-between">
                    ...
                    <div className="flex flex-col items-center gap-2">
                      ...
                      <span className="text-xs text-muted-foreground">{poem.likes}</span>
                    </div>
                  </div>
                </CardContent>
              </Card>
