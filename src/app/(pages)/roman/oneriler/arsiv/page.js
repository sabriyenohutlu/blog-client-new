...
import { Calendar, Clock, Star, ThumbsUp, MessageSquare, Bookmark } from "lucide-react";
import {
  Select,
  SelectContent,
  SelectItem,
...
const recommendations = [
  {
    ...
    description: "Latin Amerika edebiyatının başyapıtı, yedi nesil boyunca Buendía ailesinin destansı öyküsünü anlatırken, insanlık tarihinin bir mikrokozmosunu sunar...",
    rating: 4.9,
    readTime: "18 saat",
    difficulty: "Orta",
    likes: 3456,
  ...
  },
  {
    ...
    description: "Adalet, merhamet ve kurtuluş temalı bu başyapıt, 19. yüzyıl Fransa'sında geçen unutulmaz bir destan sunar...",
    rating: 4.8,
    readTime: "25 saat",
    difficulty: "Zor",
    likes: 2987,
  ...
  },
  {
    ...
    description: "İnsan psikolojisinin derinliklerine inen, suç ve vicdanı sorgulayan bu başyapıt, modern edebiyatın temel taşlarından biridir...",
    rating: 4.9,
    readTime: "20 saat",
    difficulty: "Zor",
    likes: 3124,
  ...
  },
  {
    ...
    description: "Totaliter bir dünyada özgürlük ve bireysellik mücadelesini anlatan, günümüzde bile geçerliliğini koruyan bir distopya klasiği...",
    rating: 4.7,
    readTime: "12 saat",
    difficulty: "Orta",
    likes: 4567,
  ...
  },
  {
    ...
    description: "Irkçılık ve adaletsizliğe karşı mücadeleyi bir çocuğun gözünden anlatan, Amerikan edebiyatının başyapıtlarından biri...",
    rating: 4.8,
    readTime: "15 saat",
    difficulty: "Kolay",
    likes: 2876,
...
export default function RomanOnerilerArsiv() {
  return (
    <>
      <NextSeo
        title="Roman Önerileri Arşivi - Edebi Akış"
