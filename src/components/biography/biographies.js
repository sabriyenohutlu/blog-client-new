...
const featuredBiographies = [
  {
    ...
    excerpt:
      "Türk edebiyatının en önemli yazarlarından Sabahattin Ali'nin hayatı, eserleri ve trajik sonu...",
    famousWorks: [
  ...
  },
  {
    ...
    excerpt:
      "Modern Türk şiirinin öncüsü Nazım Hikmet'in sürgünlerle dolu hayatı ve edebi mirası...",
    famousWorks: [
  ...
  },
  {
    ...
    excerpt:
      "Türk edebiyatının en önemli modernist yazarlarından Tanpınar'ın hayatı ve edebi yolculuğu...",
...
const recentBiographies = [
  {
    ...
    views: 1245,
    excerpt:
      "Modern Türk şiirinin devrimci ismi Orhan Veli'nin kısa ama etkili edebi hayatı...",
  },
  {
    ...
    views: 982,
    excerpt:
      "Türk edebiyatının postmodern öncüsü Oğuz Atay'ın sıra dışı yaşamı...",
  },
  {
    ...
    views: 876,
    excerpt:
      "Çağdaş Türk öykücülüğünün güçlü kalemi Tomris Uyar'ın yaşamı ve eserleri...",
  },
];
